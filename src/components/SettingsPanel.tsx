      ...
      {!collapsed && (
        <div className="space-y-4 pt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-neutral-700">BCE Era Name</label>
              <input
                type="text"
                value={config.era_bce}
                onChange={(e) => handleChange('era_bce', e.target.value)}
                className="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-neutral-700">CE Era Name</label>
              <input
                type="text"
                value={config.era_ce}
                onChange={(e) => handleChange('era_ce', e.target.value)}
                className="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
          </div>
